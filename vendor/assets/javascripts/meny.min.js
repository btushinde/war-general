...
e.cover.style.zIndex=1000;e.cover.style.visibility="hidden";e.cover.style.opacity=0;try{e.cover.style.background="rgba( 0, 0, 0, 0.4 )";e.cover.style.background="-ms-linear-gradient("+D.position+", rgba(255,255,255,0.40) 0%,rgba(255,255,255,0.65) 100%)";
e.cover.style.background="-moz-linear-gradient("+D.position+", rgba(255,255,255,0.40) 0%,rgba(255,255,255,0.65) 100%)";e.cover.style.background="-webkit-linear-gradient("+D.position+", rgba(255,255,255,0.40) 0%,rgba(255,255,255,0.65) 100%)";
